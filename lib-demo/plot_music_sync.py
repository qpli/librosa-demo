...
x_1, fs = librosa.load('1.wav')
# from scipy import signal
# b, a = signal.cheby1(4, 5, 16000/fs*0.5, "highpass") # lowpass
# yt1  = signal.filtfilt(b, a, x_1)
# x_1 = yt1
...
x_2, fs = librosa.load('2.wav')
# from scipy import signal
# b, a = signal.cheby1(4, 5, 16000/fs*0.5, "highpass") # lowpass
# yt2  = signal.filtfilt(b, a, x_2)
# x_2 = yt2
plt.figure(figsize=(16, 4))
